...
console.log(inputs)
    return (
        ...
        >
            <div 
            className=' mx-auto h-full flex flex-1 justify-center items-center'
            >
                <div 
                ...
                >
                    ...
                    >
                        <form 
                        className=' m-4 p-10 backdrop-blur-md bg-white/40 rounded shadow-xl'
                        style={{
                        ...
                        >
                            ...
                            <div>
                                ...
                                >
                                    <i 
                                    className='absolute pointer-events-none pl-1'
                                    >
                                        <AccountCircleIcon />
                                    </i>
                                    <input 
